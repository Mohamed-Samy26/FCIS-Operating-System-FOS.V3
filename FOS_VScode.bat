...
set PATH=%PATH%;%local_directory%\bin;%local_directory%\opt\cross\bin;
set PATH=%PATH%;%local_directory%\qemu;
set PATH=%PATH%;%local_directory%\mingw\mingw64\bin;

rem set PATH=%PATH%;${PWD}\..\..\bin;${PWD}\..\..\opt\cross\bin
